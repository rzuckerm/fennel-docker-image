FENNEL_VERSION := $(shell cat FENNEL_VERSION)
FENNEL_DEPS := $(wildcard FENNEL_*)
DOCKER_TAG_PREFIX := rzuckerm/fennel:$(FENNEL_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(FENNEL_DEPS)
